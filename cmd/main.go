...
import (
	...
	"github.com/OrRener/cert-renewer-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "73caa1c4.compute.io",
	...
	if err := (&controller.OCPNewCertificateRequestReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "OCPNewCertificateRequest")
		os.Exit(1)
	}
